...
- **Power Master** creates condition-specific pacing targets and printable stem tape.
...
├── power-master.css       # Compact tape-editor layout and responsive behavior
├── power-master.html      # Power planning and tape interface
...
Power Master starts with the established seven condition targets and can add or replace them with duration-scaled profile templates. Target text and background colors are preserved in saved plans and the tape preview.
